...
/**
 * The test class PlaysLastTest.
 *
 * @author  (your name)
 * @version (a version number or a date)
 */
public class PlaysLastTest
{
    /**
     * Default constructor for test class PlaysLastTest
     */
    public PlaysLastTest()
    {
    }
    ...
    public void playerTest(){
        ...
        Player test = new PlaysLast(start, exits, 100);
    ...
    public void pickTest(){
        ...
        Player test = new PlaysLast(start, exits, 100);
        assertEquals(test.getNode().getNeighbor(test.getNode().getNeighbors().size()-1), test.pick());
    }
