...
/**
 * The test class PlaysShortestTest.
 *
 * @author  (your name)
 * @version (a version number or a date)
 */
public class PlaysShortestTest
{
    /**
     * Default constructor for test class PlaysShortestTest
     */
    public PlaysShortestTest()
    {
    }
    ...
    public void playerTest(){
        ...
        Player test = new PlaysShortest(graph, start, exits, 100);
    ...
    public void pickTest(){
        ...
        Player test = new PlaysShortest(graph, start, exits, 100);
        assertEquals(test.getNode().getNeighbor(1), test.pick());
    }
}
