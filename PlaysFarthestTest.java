...
/**
 * The test class PlaysFarthestTest.
 *
 * @author  (your name)
 * @version (a version number or a date)
 */
public class PlaysFarthestTest 
{
    /**
     * Default constructor for test class PlaysFarthestTest
     */
    public PlaysFarthestTest()
    {
    }
    ...
    public void playerTest(){
        ...
        Player test = new PlaysFarthest(graph, start, exits, 100);
    ...
    public void pickTest(){
        ...
        Player test = new PlaysFarthest(graph, start, exits, 100);
        assertEquals(test.getNode().getNeighbor(2), test.pick());
    }
}
