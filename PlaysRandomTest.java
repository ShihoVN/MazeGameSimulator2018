...
/**
 * The test class PlaysRandomTest.
 *
 * @author  (your name)
 * @version (a version number or a date)
 */
public class PlaysRandomTest
{
    /**
     * Default constructor for test class PlaysRandomTest
     */
    public PlaysRandomTest()
    {
    }
    ...
    public void playerTest(){
        ...
        Player test = new PlaysRandom(start, exits, 100);
    ...
    public void pickTest(){
        ...
        Player test = new PlaysRandom(start, exits, 100);
        assertTrue(test.getNode().getNeighbors().contains(test.pick()));
